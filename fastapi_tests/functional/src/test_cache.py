...
async def test_shows_show_id_cache(
    ...
    await es_async_client.delete(
        index=test_settings.show_index_name, id=show_id
    )
...
async def test_persons_cache_pass(
    aiohttp_get, es_async_client, restore_indexes_after
) -> None:
    ...
    await es_async_client.delete(
        index=test_settings.person_index_name, id=person_id
    )
...
async def test_genres_cache_pass(
    aiohttp_get, es_async_client, restore_indexes_after
) -> None:
    ...
    await es_async_client.delete(
        index=test_settings.genre_index_name, id=genre_id
    )
